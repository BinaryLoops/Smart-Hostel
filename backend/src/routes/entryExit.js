...
import { adminListEntryExit, createEntryExit, listMyEntryExit, processScannerLog } from '../controllers/entryExitController.js'
...
entryExitRouter.post('/scan', processScannerLog)
